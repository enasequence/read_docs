...
|                         +------------------------------------------+-------------------------------------+
| Note:Number of sequences| 1 FASTA file                             | For unannotated assemblies          |
| should be more than 2   +------------------------------------------+-------------------------------------+
| and less than 1,000,000.| 1 Flat file                              | For annotated assemblies            |
+-------------------------+------------------------------------------+-------------------------------------+
...
|                         +------------------------------------------+-------------------------------------+
| Note:To submit unplaced | 0-1 AGP file                             | To submit unplaced contigs and      |
| contigs,submit at lower |                                          | indicate which scaffolds/contigs are|
| level  with AGP file.   |                                          | assembled to form each chromosome   |
+-------------------------+------------------------------------------+-------------------------------------+
