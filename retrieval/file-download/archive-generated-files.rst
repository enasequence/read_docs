...
ENA presents two versions of the data it holds: the files as you submitted them, and equivalent files generated by the
archive in a consistent format. This page describes what is generated, how the generated files are named, and the
format of their contents.

For why both versions exist, see
`Why Are There Two Versions Of My Files? <../../faq/archive-generated-files.html#why-are-there-two-versions-of-my-files>`_.


Run Files
=========

Both versions are visible in the ENA Browser view for runs:
