...
ENA provides access to two types of file for the data it presents: the file(s) you submitted, and file(s)
generated by the archive. This page explains why, and how the two differ, for **runs** and for **analyses**.


What Files Does ENA Provide For My Runs?
========================================
...
What Files Does ENA Provide For My Analyses?
============================================
